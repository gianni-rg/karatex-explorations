...
uv_coords = [uvs_K4A_Gianni, uvs_K4A_Tino, uvs_K4A_Master, None]
...
filenames = ["K4A_Gianni-ReferenceFrame1.png", "K4A_Tino-ReferenceFrame1.png", "K4A_Master-ReferenceFrame1.png"]
...
if __name__ == "__main__":
    ...
    for  file in filenames:
        ...
        for uv in uv_coords[ctr]:
            cv2.circle(img, (uv[0], uv[1]), 1, (0, 0, 255), -1)
        cv2.imshow(fullpath, cv2.resize(img, (1920, 1080)))
        cv2.waitKey(0)
