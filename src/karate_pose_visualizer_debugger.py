...
@click.option('--clip_name', type=click.STRING, required=True, default="20230714_193921", help='name of the clips folder')
...
@click.option('--input_2d_poses', type=click.STRING, required=True, default="cleaned_smoothed", help='relative path folder for the output')
@click.option('--input_3d_poses', type=click.STRING, required=True, default="output_3d_Smooth", help='relative path folder for the output')
